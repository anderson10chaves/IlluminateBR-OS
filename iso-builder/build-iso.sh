...
sudo apt-get install -y live-build xorriso mtools grub-pc-bin grub-efi-amd64-bin syslinux-utils
...
echo "⚙️ Configurando o live-build com GRUB e imagem ISO pura (xorriso)..."
lb config \
    --binary-images iso \
